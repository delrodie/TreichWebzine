...
class Dossier
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\TypeDossier", inversedBy="dossiers")
     ...
     * Set type
     *
     * @param \AppBundle\Entity\TypeDossier $type
     *
     * @return Dossier
     */
    public function setType(\AppBundle\Entity\TypeDossier $type = null)
    {
        $this->type = $type;
